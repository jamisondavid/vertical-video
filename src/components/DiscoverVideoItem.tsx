...
import { Heart, MessageCircle, Music, Tag, Bookmark, ExternalLink, Grid } from "react-native-feather"
import VideoLoader from "./VideoLoader"
import { Gesture, GestureDetector } from "react-native-gesture-handler"

const { width: windowWidth, height: windowHeight } = Dimensions.get("window")

interface DiscoverVideoItemProps {
  video: {
    id: string
    videoUri: string
    user: {
...
const DiscoverVideoItem = ({ video, isActive, onSaveVideo, onOpenArticle, onShowRelated }: DiscoverVideoItemProps) => {
    ...
    <GestureDetector gesture={gesture}>
      <View style={styles.container}>
        ...
        <View style={styles.categoryBadge}>
          <Tag width={14} height={14} color="white" />
        ...
        <View style={styles.bottomContainer}>
          <View style={styles.bottomLeftContainer}>
            ...
            <View style={styles.musicContainer}>
              ...
              <Text style={styles.musicText}>Trending Sound</Text>
            </View>
          </View>
        </View>
...
export default DiscoverVideoItem
